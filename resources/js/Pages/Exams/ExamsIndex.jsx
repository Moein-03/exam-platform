        ...
        <AuthenticatedLayout user={auth.user} header="مدیریت آزمون‌ها" isTeacher={isTeacher}>
            ...
            <TableContainer component={Paper} sx={{ overflowX: 'auto' }}>
                <Table sx={{ minWidth: { xs: 600, sm: '100%' }, direction: 'rtl' }}>
                    <TableHead>
                        <TableRow>
                            <TableCell sx={{ paddingLeft: '40px' }}>عنوان</TableCell>
                            <TableCell sx={{ textAlign: 'center' }}>تاریخ برگزاری</TableCell>
                    ...
                    <TableBody>
                        {exams.data.map(exam => (
                            <TableRow key={exam.id}>
                                ...
                                <TableCell>{toPersianNumber(exam.duration_min)}</TableCell>
                                <TableCell>
                                    <Chip
                                        label={exam.status}
